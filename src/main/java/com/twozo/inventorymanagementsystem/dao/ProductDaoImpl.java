...
public class ProductDaoImpl implements ProductDao<Product> {
    ...
    @Override
    public Collection<Product> getAll(final int pageNumber, final int pageSize) {
        final String query = "SELECT id, name, purchase_price, mrp, tax_rate, discount_rate, selling_price, stock_quantity FROM \"inventoryDB\".\"Product\" "+"LIMIT ? OFFSET ?";
